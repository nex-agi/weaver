...
class AsyncTrainingClient:
    ...
    async def publish_weights(
        ...
        *,
        ...
        See :meth:`weaver.training_client.TrainingClient.publish_weights`.
        ...
        if selection.is_live_collective:
            await self.publish_live_weights_to_sampler_nccl_v1(
                sampling_client,
        ...
        return await self._service.create_sampling_client(
